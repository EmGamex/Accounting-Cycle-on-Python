...
class TestUIModular(unittest.TestCase):
    ...
    def test_exportaciones_principales(self):
        ...
        self.assertTrue(callable(ui.generar_tabla_balance_4_columnas))
        self.assertTrue(callable(ui.generar_tabla_balance_general))
        self.assertTrue(callable(ui.generar_tabla_estado_resultados))
